package com.example.colorclub.constants;
...
public class NormalConstants {
     ...
     * 邮箱验证码文本信息
     */
    public static final String REGIS_TITLE = "川农社团云注册账号邮箱验证码";
    public static final String REGIS_CONTEXT = "您好，您用于注册川农社团云的邮箱验证码是：%s，该验证码15分钟内有效。\n若非本人操作，请忽略此邮件。";
    public static final String RESETTING_TITLE = "川农社团云重置密码邮箱验证码";
    public static final String RESETTING_CONTEXT = "您好，您用于重置川农社团云账号密码的邮箱验证码是：%s，该验证码15分钟内有效。\n若非本人操作，请忽略此邮件。";
    /**
     * Redis前缀或键
     */
